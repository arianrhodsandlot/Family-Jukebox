var prelude = {
  channels: [{
    name: 'square1',
    config: {
      instrument: {waveform: 'square', sampleRate: 44100, bpm: 400, waveEndsBy: 0.8},
      audio: {volume: 0.2}
    },
    notes: [
      -3, -3, null,
    ...
    name: 'triangle',
    config: {
      instrument: {waveform: 'triangle', sampleRate: 44100, bpm: 400, fadeOut: {from: 0.8, to: 1}},
      audio: {volume: 0.3}
    },
    notes: [
      -19, -19, null,
    ...
    name: 'noise',
    config: {
      instrument: {waveform: 'noise', sampleRate: 44100, bpm: 400},
      audio: {volume: 0.2}
    },
    notes: [
...
window.dispatchEvent(new CustomEvent('chaptersLoaded', {detail: chapters}))
